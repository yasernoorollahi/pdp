...
public interface UserContextFlagRepository extends JpaRepository<UserContextFlag, UUID> {

    @Query("select u.sourceHash from UserContextFlag u where u.sourceHash in :hashes")

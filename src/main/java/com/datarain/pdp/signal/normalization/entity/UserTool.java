...
@Table(name = "user_tools",
        indexes = {
                @Index(name = "idx_user_tools_user", columnList = "user_id"),
                @Index(name = "idx_user_tools_signal", columnList = "signal_id"),
                @Index(name = "idx_user_tools_source_hash", columnList = "source_hash")
        })
public class UserTool extends AuditableEntity {
